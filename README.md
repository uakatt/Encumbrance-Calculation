...
* revision 8119 contains the following liquibase changesets: update/KITT-834.xml, latest/dat/KREW.xml
* revision 8325 contains the following liquibase changesets: update/KITT-834.xml
...
* **patches/09307_KITT-834.diff** is the patch file for #9307.
* **patches/11045_KITT-834.diff** is the patch file for #11045.
* **patches/11189_KITT-834.diff** is the patch file for #11189.
* **patches/11539_KITT-834.diff** is the patch file for #11539.
* **patches/11905_KITT-834.diff** is the patch file for #11905.
* **patches/12247_KITT-834.diff** is the patch file for #12247.
* **patches/12292_KITT-834.diff** is the patch file for #12292.
* **patches/12493_KITT-834.diff** is the patch file for #12493.
* **patches/12756_KITT-834.diff** is the patch file for #12756.
* **patches/12758_KITT-834.diff** is the patch file for #12758.
* **patches/14054_KITT-834.diff** is the patch file for #14054.
* **patches/14055_KITT-834.diff** is the patch file for #14055.
* **patches/14666_KITT-834.diff** is the patch file for #14666.
* **patches/14695_KITT-834.diff** is the patch file for #14695.
* **patches/14615_KITT-842.diff** is the patch file for #14615.
* **patches/14616_KITT-842.diff** is the patch file for #14616.
* **patches/18271_KFSI-3563.diff** is the patch file for #18271.
* **patches/18359_KFSI-3563.diff** is the patch file for #18359.
* **patches/18360_KFSI-3563.diff** is the patch file for #18360.
...
Files **created** for this modification.
...
Files **modified** for this modification.
...
This means, for example, that "spring-ld.xml" was changed for this modification, but its history was not used to build this list of revisions.
